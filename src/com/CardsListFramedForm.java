...
public class CardsListFramedForm extends FramedForm implements CommandListener {
	...
	public CardsListFramedForm(String title, int cardSet) {
		this(title, cardSet, null);
	}
	
	public CardsListFramedForm(String title, int cardSet, Style style) {
		super(title, style);
	...
	public void setCards(Cards cards) {
		this.deleteAll(Graphics.BOTTOM);
		if ( cards == null )
			return;
